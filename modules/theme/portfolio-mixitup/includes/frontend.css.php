<?php if ( $settings->categories_nav != 'hide' ) { ?>
	...
	.fl-node-<?php echo $id; ?> .portfolio-filter {
		<?php if ( $settings->buttons_spacing <> '' ) { ?>
	...
	.fl-node-<?php echo $id; ?> .portfolio-filter .portfolio-button {
	...
	.fl-node-<?php echo $id; ?> .portfolio-filter .portfolio-button:not(.active) {
	...
	.fl-node-<?php echo $id; ?> .portfolio-filter .portfolio-button.active,
	.fl-node-<?php echo $id; ?> .portfolio-filter .portfolio-button:hover {
	...
	.fl-node-<?php echo $id; ?> .portfolio-filter.left {
		<?php if ( $settings->button_padding_left <> '' ) { ?>
	...
	.fl-node-<?php echo $id; ?> .portfolio-filter.right {
		<?php if ( $settings->button_padding_right <> '' ) { ?>
...
<?php if ( $settings->grid_style != ' none') { ?>
	...
	<?php if ( !empty($settings->grid_info_title_color) || $settings->grid_info_title_size || $settings->grid_info_title_weight <> '' || $settings->grid_info_title_transform <> '' || $settings->grid_info_title_spacing <> '' ) { ?>
		.fl-node-<?php echo $id; ?> .grids .portfolio-title {
	...
	<?php if ( !empty($settings->grid_desc_color) || $settings->grid_desc_size || $settings->grid_desc_minheight <> '' || $settings->grid_desc_weight <> '' || $settings->grid_desc_transform <> '' || $settings->grid_desc_spacing <> '' ) { ?>
		.fl-node-<?php echo $id; ?> .grids .portfolio-desc {
	...
	<?php if ( $settings->grid_button_text <> '' ) { ?>
		...
		.fl-node-<?php echo $id; ?> .grids .portfolio-button {
			<?php if ( $settings->grid_button_font_weight <> '' ) { ?>
		...
		.fl-node-<?php echo $id; ?> .grids .portfolio-button:not(.active) {
		...
		.fl-node-<?php echo $id; ?> .grids .portfolio-button.active,
		.fl-node-<?php echo $id; ?> .grids .portfolio-button:hover {
...
.fl-node-<?php echo $id; ?> .portfolio-mixitup .grids { padding-right: <?php echo $settings->grid_spacing; ?>px; margin-left: -<?php echo $settings->grid_spacing; ?>px; width: calc(100% + <?php echo $settings->grid_spacing; ?>px + <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(100% + <?php echo $settings->grid_spacing; ?>px + <?php echo $settings->grid_spacing; ?>px); }
.fl-node-<?php echo $id; ?> .portfolio-mixitup .grids [class*="grid-"] { margin: 0 0 <?php echo $settings->grid_spacing; ?>px <?php echo $settings->grid_spacing; ?>px; }
@media only screen and ( min-width: 981px ) { 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2 { width: calc(16% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(16% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2-5 {  width: calc(20% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(20% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-3 { width: calc(25% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(25% - <?php echo $settings->grid_spacing; ?>px); }
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-4 { width: calc(33.33% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(33.33% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-6 { width: calc(50% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(50% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-12 { width: calc(100% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(100% - <?php echo $settings->grid_spacing; ?>px); } 
}
@media only screen and ( max-width: 980px ) {
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2-5 { width: calc(25% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(25% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-3,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-4 { width: calc(50% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(50% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-6,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-12 { width: calc(100% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(100% - <?php echo $settings->grid_spacing; ?>px); } 
}
@media only screen and ( max-width: 767px ) { 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2-5 { width: calc(33.33% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(33.33% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-3,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-4 { width: calc(50% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(50% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-6,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-12 { width: calc(100% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(100% - <?php echo $settings->grid_spacing; ?>px); } 
...
@media only screen and ( max-width: 580px ) { 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2-5,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-3,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-4 { width: calc(50% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(50% - <?php echo $settings->grid_spacing; ?>px); } 
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-6,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-12 { width: calc(100% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(100% - <?php echo $settings->grid_spacing; ?>px); } 
...
@media only screen and ( max-width: 480px ) { 
	...
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-2-5,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-3,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-4,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-6,
	.fl-node-<?php echo $id; ?> .portfolio-mixitup .grid-12 { width: calc(100% - <?php echo $settings->grid_spacing; ?>px); width: -webkit-calc(100% - <?php echo $settings->grid_spacing; ?>px); } 
}
<?php } ?>