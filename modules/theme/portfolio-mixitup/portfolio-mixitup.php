<?php
/**
 * @class portfolioMixItUpModule
 */
class portfolioMixItUpModule extends FLBuilderModule {
	...
	public function __construct()
	{
		...
		parent::__construct(array(
			'name'          	=> __('Portfolio - MixItUp', 'fl-builder'),
			'description'   	=> __('Display Portfolio from Posttype.', 'fl-builder'),
	...
	{
		$classname = 'portfolio-mixitup'.$this->settings->grid_style;
		return $classname;
	}
}

/*Testimonial Avatar Size*/
add_image_size( 'portfolio-mixitup-large', 500 , 347, true );
add_image_size( 'portfolio-mixitup', 375 , 260, true );
 ...
 */
FLBuilder::register_module('portfolioMixItUpModule', array(
	'slides'         => array(
			...
			'filter'       => array(
				...
				'fields'        => array(
					...
					'categories_nav_all_text'         => array(
						...
						'preview'       => array(
							'type'          => 'text',
							'selector'      => '.portfolio-button[data-filter="all"]',
						)
					),
				)
			),
			...
			'button_font'       => array(
				...
				'fields'        => array(
					'button_font_weight'           => array(
						...
						'preview'       => array(
							'type'          => 'css',
							'selector'      => '.portfolio-filter .portfolio-button',
			...
			'button_color'       => array(
				...
				'fields'        => array(
					'button_bg_color'           => array(
						...
						'preview'       => array(
							'type'          => 'css',
							'selector'      => '.portfolio-filter .portfolio-button:not(.active)',
					...
					'button_bg_color_active'           => array(
						...
						'preview'       => array(
							'type'          => 'css',
							'selector'      => '.portfolio-filter .portfolio-button.active',
							'property'      => 'background-color',
						)
					),
			...
			'grid_button'       => array(
				...
				'fields'        => array(
					'grid_button_text'           => array(
						...
						'preview'       => array(
							'type'          => 'text',
							'selector'      => '.grids .portfolio-button:not(.active)',
						)
					),
			...
			'grid_button_padding'       => array(
				...
				'fields'        => array(
					'grid_button_padding_top'           => array(
						...
						'preview'       => array(
							'type'          => 'css',
							'selector'      => '.grids .portfolio-button',
							'property'      => 'padding-top',
							'unit'	      => 'px',
						)
					),
...
add_action( 'wp_ajax_nopriv_getPortfolioItemAjax', 'getPortfolioItemAjax' ); 
add_action( 'wp_ajax_getPortfolioItemAjax', 'getPortfolioItemAjax' );
function getPortfolioItemAjax() { 
	$postID = isset($_POST['id']) ? $_POST['id'] : 0; 
	query_posts('p='.$postID.'&post_type=portfolio');
	if ( have_posts()) : while (have_posts()) : the_post();
?>
	<div class="ajax-portfolio-content">
		<figure class="ajax-portfolio-img">
			<?php 
				$postIMG = wp_get_attachment_image_src( get_post_thumbnail_id( $postID ), 'ajax-lightbox-image' ); 
				$postIMGurl = ( $postIMG ) ? $postIMG[0] : FL_MODULE_THEME_URL .'modules/theme/portfolio-mixitup/img/default.svg';
		...
		<aside class="ajax-portfolio-text">
			<div class="ajax-portfolio-text-info">
				<h4 class="title"><?php the_title(); ?></h4>
				<ul class="ajax-portfolio-list">
					<li>
					...
					<li>
						...
						<span><?php the_terms( $postID, 'portfolio_category' ); ?></span>
					</li>
					<li>
			...
			<div class="ajax-portfolio-text-desc">
