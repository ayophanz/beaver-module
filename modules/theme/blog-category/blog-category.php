 ...
 */
class blogCategoryModule extends FLBuilderModule {
	...
	public function __construct()
	{
		...
		parent::__construct(array(
			'name'          	=> __('Blog Category', 'fl-builder'),
			'description'   	=> __('Display Blog Grids by Category.', 'fl-builder'),
	...
	{
		$classname = 'blog blog-category '.$this->settings->style;
		return $classname;
	}
}
 ...
 */
FLBuilder::register_module('blogCategoryModule', array(
	'general'         => array(
		...
		'sections'      => array(
				...
				'fields'        => array(
					...
					'orderby'         => array(
						...
						'options'       => array(
							...
							'menu_order'    => __('Menu Order or Drag & Drop', 'fl-builder'),
							''    		=> __('', 'fl-builder'),
						),
					),
					'order'         => array(
			...
			'content'       => array(
				...
				'fields'        => array(
					...
					'post_readmore_position'   => array(
						'type'          => 'select',
						'label'         => __('Post Read More Position', 'fl-builder'),
						'default'       => 'block',
						'options'       => array(
