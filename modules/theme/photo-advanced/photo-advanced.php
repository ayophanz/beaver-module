...
/**
 * @class PhotoAdvancedModule
 */
class PhotoAdvancedModule extends FLBuilderModule {
 ...
 */
FLBuilder::register_module('PhotoAdvancedModule', array(
	'general'       => array( // Tab
			...
			'general'       => array( // Section
				...
				'fields'        => array( // Section Fields
					...
					'style'         => array(
						...
						'toggle'        => array(
							'shadow'	=> array(
								'sections'        => array('shadow_setting')
							),
						),
					)
				)
			),
			'shadow_setting'       => array(
				'title'         => __('Shadow Setting', 'fl-builder'),
				'fields'        => array(
					'shadow_color'  => array(
						'type'          => 'color',
					...
					'shadow_color_opacity'  => array(
						'type'          => 'unit',
						'label'         => __('Shadow Color Opacity', 'fl-builder'),
						'default'         => '15',
						'placeholder'         => '15',
						'description'         => '%',
					),
					'shadow_distance_x'  => array(
						'type'          => 'unit',
						'label'         => __('Shadow Disptance Horizontal', 'fl-builder'),
						'default'         => '0',
						'placeholder'         => '0',
						'description'         => 'px',
					),
					'shadow_distance_y'  => array(
						'type'          => 'unit',
						'label'         => __('Shadow Disptance Vertical', 'fl-builder'),
						'default'         => '15',
						'placeholder'         => '15',
						'description'         => 'px',
					),
					'shadow_size'  => array(
						'type'          => 'unit',
						'label'         => __('Shadow Size', 'fl-builder'),
						'default'         => '30',
						'placeholder'         => '30',
						'description'         => 'px',
					),
