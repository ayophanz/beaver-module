<?php
/**
 * @class formBoxNewsletterModules
 */
class formBoxNewsletterModules extends FLBuilderModule {
	...
	public function __construct()
	{
		...
		parent::__construct(array(
			'name'          	=> __('Form Box - Newsletter', 'fl-builder'),
			'description'      	=> __('Newsletter Box', 'fl-builder'),
	...
	{
		$classname = 'form-box-newsletter '.$this->settings->align;
		return $classname;
	}
}
/**
 ...
 */
FLBuilder::register_module('formBoxNewsletterModules', array(
	'general'         => array(
			...
			'general'       => array(
				...
				'fields'        => array(
					...
					'note'         => array(
						'type'          => 'text',
						'label'          => __('Note', 'fl-builder'),
						'default'          => 'No spam, ever Emails are never shared.',
						'placeholder'          => 'No spam, ever Emails are never shared.',
					),
				)
			),
		)
		...
		'sections'      => array(
			'setting_content'       => array(
				...
				'fields'        => array(
					...
					'bg_color_bottom'         => array(
						'type'          => 'color',
						'label'         => __('Background Gradient Bottom Color', 'fl-builder'),
						'show_reset' 	=> true,
					),
					'color'         => array(
						'type'          => 'color',
			...
			'setting_form'       => array(
				...
				'fields'        => array(
					...
					'input_spacing'         => array(
						'type'          => 'unit',
						'label'         => __('Input Spacing', 'fl-builder'),
						'default'       => '',
						'maxlength'     => '3',
						'size'          => '4',
						'description'   => 'px',
					...
					'button_bg_color_bottom'         => array(
						'type'          => 'color',
						'label'         => __('Button Bg Gradient Bottom Color', 'fl-builder'),
						'show_reset' 	=> true,
					),
				)
			),
			'setting_note'       => array(
				...
				'fields'        => array(
					'note_color'         => array(
						'type'          => 'color',
						'label'         => __('Note Color', 'fl-builder'),
						'show_reset' 	=> true,
					),
					'note_size'         => array(
						'type'          => 'unit',
						'label'         => __('Note Size', 'fl-builder'),
						'default'       => '',
						'maxlength'     => '3',
						'size'          => '4',
						'description'   => 'px',
					...
					'note_weight'         => array(
						'type'          => 'select',
						'label'         => __('Note Weight', 'fl-builder'),
						'default' 		=> '',
						'options'       => array(
							''    	=> __('Default', 'fl-builder'),
							'100'    	=> __('100 Thin', 'fl-builder'),
					...
					'note_spacing'         => array(
						'type'          => 'unit',
						'label'         => __('Note Spacing', 'fl-builder'),
						'default'       => '',
						'maxlength'     => '3',
						'size'          => '4',
						'description'   => 'px',
