...
/**
 * @class WooCommerceFeaturedModule
 */
class WooCommerceFeaturedModule extends FLBuilderModule {
	...
	{
		$classname = 'woocommerce-featured';
		return $classname;
	}
}
 ...
 */
FLBuilder::register_module('WooCommerceFeaturedModule', array(
	'general'       => array(
